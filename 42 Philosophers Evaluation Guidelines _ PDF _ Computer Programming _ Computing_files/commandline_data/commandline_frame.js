...
(() => {
  ...
  var everything = new ProgramMetadata(/* @__PURE__ */ new Map([
    ["src/excmds.ts", new FileMetadata(/* @__PURE__ */ new Map([]), /* @__PURE__ */ new Map([
      ...
      ["tabnext", new SymbolMetadata("Switch to the next tab, wrapping round.\n\nIf increment is specified, move that many tabs forwards.", new FunctionType([new ArrayType(new StringType(false, false), true, false)], new TypeReferenceType("Promise", [new TypeReferenceType("Tab", [], false, false)], false, false), false, false), false)],
      ...
      ["tabprev", new SymbolMetadata("Switch to the previous tab, wrapping round.\n\nIf increment is specified, move that many tabs backwards.", new FunctionType([new ArrayType(new StringType(false, false), true, false)], new TypeReferenceType("Promise", [new TypeReferenceType("Tab", [], false, false)], false, false), false, false), false)],
      ...
      ["tabonly", new SymbolMetadata("Close all other tabs in this window", new FunctionType([new ArrayType(new StringType(false, false), true, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ...
      ["autocmd", new SymbolMetadata("Set autocmds to run when certain events happen.", new FunctionType([new StringType(false, false), new StringType(false, false), new ArrayType(new StringType(false, false), true, false)], new TypeReferenceType("Promise", [new AnyType(true, false)], false, false), false, false), false)],
      ...
      ["profilelaunch", new SymbolMetadata('Launch a new Firefox instance with the specified profile.\n\nIf no profile name is specified, shows available profiles.\nRequires the native messenger to be installed.\n\nExample: `profilelaunch myprofile`\nExample: `profilelaunch "Work Profile"`', new FunctionType([new StringType(false, true)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ["profilecreate", new SymbolMetadata('Create a new Firefox profile.\n\nExample: `profilecreate "New Profile"`', new FunctionType([new StringType(false, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ["profilerename", new SymbolMetadata('Rename a Firefox profile.\n\nExample: `profilerename "Old Name" "New Name"`', new FunctionType([new StringType(false, false), new StringType(false, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ["hintstylesnohighlights", new SymbolMetadata("Disable all hilighting of hintable elements when hinting.\nOnly hint flags will remain, Vimium style.", new FunctionType([], new VoidType(false, false), false, false), false)],
      ["hintstylesoverlays", new SymbolMetadata("Add highlights over the page when hinting and leave original elements unchanged.", new FunctionType([], new VoidType(false, false), false, false), false)],
      ["hintstylesdirect", new SymbolMetadata("Style hintable elements directly when hinting.", new FunctionType([], new VoidType(false, false), false, false), false)]
    ]))],
    ["src/lib/config.ts", new FileMetadata(/* @__PURE__ */ new Map([["default_config", new ClassMetadata(/* @__PURE__ */ new Map([
      ...
      ["newtab", new SymbolMetadata("URL the newtab will redirect to.\n\nAll usual rules about things you can open with `open` apply, with the caveat that you'll get interesting results if you try to use something that needs `nativeopen`: so don't try `about:newtab` or a `file:///` URI. You can instead host a local webserver (e.g. Caddy).", new StringType(false, false), false)],
      ...
      ["downloadfilenamemarker", new SymbolMetadata('Placeholder string used in ":saveas" targets. If the save-as path\ncontains this marker, it will be replaced with the filename\nderived from the URL.\n\nFor example, using:\n\n   :saveas ~/Documents/ex-%\n\nwith the URL:\n\n   https://example.com/log.txt\n\nwill produce the file:\n\n   ~/Documents/ex-log.txt', new StringType(false, false), false)],
      ...
      ["containerindicator", new SymbolMetadata("If modeindicator is enabled, containerindicator will color the border of the mode indicator with the container color.", new UnionType([
        new LiteralTypeType("false", false, false),
        new LiteralTypeType("true", false, false)
      ], false, false), false)],
...
statistics, so somewhere around 10k samples.`, new StringType(false, false), false)],
      ...
      ["reader_articles", new SymbolMetadata("Internal temporary storage for :reader, mapping UUIDs to base64 encoded html strings of articles", new ObjectType(/* @__PURE__ */ new Map([["", new StringType(false, false)]]), false, false), false)]
    ]))]]), /* @__PURE__ */ new Map([
      ...
      ["get", new SymbolMetadata("Get the value of the key target.\n\nIf the user has not specified a key, use the corresponding key from\ndefaults, if one exists, else undefined.", new FunctionType([new UnionType([
        ...
        new TypeReferenceType("... 99 more ...", [], false, false),
        new LiteralTypeType("reader_articles", false, false)
...
When adding updaters, don't forget to set("configversion", newversionnumber)!`, new FunctionType([], new TypeReferenceType("Promise", [new BooleanType(false, false)], false, false), false, false), true)],
  ...
  var staticThemes = ["auto", "dark", "default", "greenmat", "halloween", "midnight", "quake", "quakelight", "shydactyl", "tokyonight", "vimium"];
  ...
  var HistoryCompletionOption = class extends CompletionOptionHTML {
    constructor(page, options) {
      ...
      let pre = preplain;
      if (get2("completions", "Tab", "statusstylepretty") === "true" || get2("completions", "History", "statusstylepretty") === "true") {
        pre = page.bmark ? "\u2B50" : "";
  ...
  async function theme(element) {
    ...
    const hintElemRules = (hintElemOptions.fg === "all" ? `    color: var(${hintFgVar}) !important;
` : "") + (hintElemOptions.bg === "all" ? "    background: var(--tridactyl-hint-bg) !important;\n" : "") + (hintElemOptions.outline === "all" ? "    outline: var(--tridactyl-hint-outline) !important;\n" : "");
    const activeElemRules = (hintElemOptions.fg !== "none" ? `    color: var(${activeFgVar}) !important;
` : "") + (hintElemOptions.bg !== "none" ? "    background: var(--tridactyl-hint-active-bg) !important;\n" : "") + (hintElemOptions.outline !== "none" ? "    outline: var(--tridactyl-hint-active-outline) !important;\n" : "");
    const activeOverlayRules = (hintElemOptions.overlay === "active" ? ".TridactylHintHighlight { display:none; } .TridactylHintHighlightActive { display: block !important; }" : "") + (hintElemOptions.overlayoutline === "active" ? ".TridactylHintOutline { display:none; } .TridactylHintOutlineActive { display: block !important; }" : "");
  ...
  addChangeListener("hintstyles", retheme);
  ...
  // src/lib/profiles.ts
  var logger9 = new logging_default("profiles");
  async function getProfilesDir() {
    return getFirefoxDir();
  }
  ...
  function processProfileSection(data, profilesDir, defaultProfile) {
  ...
  function parseIniSections(content) {
    ...
    for (const line of lines) {
      ...
      if (trimmed.startsWith("[") && trimmed.endsWith("]")) {
        ...
        const sectionType = sectionName.startsWith("Profile") ? "profile" : sectionName.startsWith("Install") ? "install" : "other";
        currentSection = {
          type: sectionType,
          name: sectionName,
          data: {}
  ...
  function parseProfilesIni2(content, profilesDir) {
    var _a;
    const sections = parseIniSections(content);
    const defaultProfile = (_a = sections.filter((section) => section.type === "install").map((section) => section.data.Default).find(Boolean)) != null ? _a : null;
    const profiles = sections.filter((section) => section.type === "profile").map(
      (section) => processProfileSection(section.data, profilesDir, defaultProfile)
    ).filter((profile) => profile !== null);
    return { profiles, defaultProfile };
  }
  async function isProfileInUse(profilePath) {
    const separator = (await browserBg.runtime.getPlatformInfo()).os === "win" ? "\\" : "/";
    const lockResult = await read(`${profilePath}${separator}lock`);
    const parentLockResult = await read(
      `${profilePath}${separator}.parentlock`
    );
    return lockResult.code === 0 || parentLockResult.code === 0;
  }
  async function checkProfilesUsage(profiles) {
  ...
  async function listProfiles() {
    try {
      ...
      const response = await read(profilesIni);
      if (response.code !== 0) {
        logger9.error(
      ...
      const { profiles } = parseProfilesIni2(response.content, profilesDir);
      if ((await browserBg.runtime.getPlatformInfo()).os === "win") {
      ...
      logger9.error("Failed to list profiles:", error);
      return [];
    }
  }

  // src/completions/Profile.ts
  var logger10 = new logging_default("profiles-completion");
  var ProfileCompletionOption = class extends CompletionOptionHTML {
    constructor(profile) {
      super();
      this.fuseKeys = [];
  ...
  var ProfileCompletionSource = class extends CompletionSourceFuse {
    constructor(_parent) {
      super(
    ...
    async updateOptions(exstr = "") {
      ...
      try {
        ...
        logger10.warning("Failed to load profiles for completion:", e);
        this.options = [];
      }
      this.completion = void 0;
      return this.updateChain();
  ...
  // src/commandline_frame.ts
  var logger11 = new logging_default("cmdline");
  ...
  function enableCompletions() {
    if (!commandline_state.activeCompletions) {
      ...
      logger11.debug(commandline_state.activeCompletions);
    }
  }
  ...
  function focus() {
    ...
    logger11.debug("commandline_frame clInput focus(), activeElement is clInput: " + (window.document.activeElement === commandline_state.clInput));
  ...
  commandline_state.clInput.addEventListener(
    ...
    function(keyevent) {
      if (!keyevent.isTrusted)
        return;
      logger11.debug("commandline_frame clInput keydown event listener", keyevent);
  ...
  commandline_state.clInput.addEventListener("input", () => {
    logger11.debug("commandline_frame clInput input event listener");
    clInputValueChanged();
  });
  ...
  function fillcmdline(newcommand, trailspace = true, ffocus = true) {
    logger11.debug("commandline_frame fillcmdline(newcommand = " + newcommand + " trailspace = " + trailspace + " ffocus = " + ffocus + ")");
    if (trailspace)
  ...
  logger11.debug("Added commandline_frame message listener");
